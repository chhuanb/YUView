...
{
  if (name.find("nv12") != std::string::npos || name.find("yuv_sp420") != std::string::npos || name.find("sp420_uv") != std::string::npos)
  {
  ...
  if (name.find("nv21") != std::string::npos || name.find("yvu_sp420") != std::string::npos || name.find("sp420_vu") != std::string::npos)
  {
